 ...
 * (common, nav, auth, dashboard, projects, processing, uploads, workspace, transcript, translation, voices, timeline, review, quality, exports, errors), `ar`/`ru` partial
...
void i18n.use(initReactI18next).init({
  ...
  ns: ['common', 'nav', 'auth', 'dashboard', 'projects', 'processing', 'uploads', 'workspace', 'transcript', 'translation', 'voices', 'timeline', 'review', 'quality', 'exports', 'errors'],
  interpolation: {
